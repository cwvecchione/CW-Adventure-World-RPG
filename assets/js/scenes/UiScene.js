class UiScene extends Phaser.Scene {
  ...
  setupUiElements() {
    ...
    this.scoreText = this.add.text(35, 8, 'Coins: 0', { fontSize: '16px', fill: '#ff' });
    ...
    this.input.on('pointerdown', (pointer, gameObjects) => {
      if (!gameObjects.includes(this.inventoryWindow.rect) && !gameObjects.includes(this.inventoryButton)) {
